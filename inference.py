    ...
    def elapseTime(self, gameState):
        ...
        for oldPos in self.allPositions:
            ...
            for newPos, prob in newPosDist.items():
                dist[newPos] += prob * self.beliefs[oldPos]
        self.beliefs = dist
...
class ParticleFilter(InferenceModule):
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for pos in self.particles:
            weightedDist[pos] += self.getObservationProb(observation, pacmanPos, pos, jailPos)
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for positions in self.particles:
            ...
            for i in range(self.numGhosts):
                ...
                p = self.getObservationProb(observation[i], pacmanPos, positions[i], jailPos)
                totalProb *= p
            weightedDist[positions] += totalProb
